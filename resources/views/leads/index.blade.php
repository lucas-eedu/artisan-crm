            ...
            <div class="card-body">
               <form>
                  <div class="row">
                     ...
                     <div class="@if(auth()->user()->profile_id != 3) col-3 @else col-4 @endif">
                        <div class="form-group">
                     ...
                     <div class="@if(auth()->user()->profile_id != 3) col-3 @else col-4 @endif">
                        <div class="form-group">
                           <select id="search_status" class="select2 form-control" name="search_status">
                              ...
                              <option value="new" @if ("new"==$search_status) selected="selected" @endif>Novo</option>
                              <option value="negotiation" @if ("negotiation"==$search_status) selected="selected" @endif>Negociando</option>
                              <option value="gain" @if ("gain"==$search_status) selected="selected" @endif>Ganho</option>
                              <option value="lost" @if ("lost"==$search_status) selected="selected" @endif>Perdido</option>
                           </select>
                        </div>
                     </div>
