      ...
      <div class="bg-white py-8 px-5 shadow rounded-lg">
         <form class="mb-0 space-y-5" method="post" action="{{ route('register') }}" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Favor confirmar que leu e concorda com os Termos de Uso do serviço'); return false; }">
            ...
            <div>
               ...
               <div class="mt-1">
                  <input type="text" id="company_name" placeholder="Nome da Empresa" name="company_name" value="{{ old('company_name') }}" class="@error('company_name') is-invalid @enderror w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:border-sky-500" />
                  @error('company_name')
            ...
            <div>
               ...
               <div class="mt-1">
                  <input id="name" placeholder="Seu nome" name="name" value="{{ old('name') }}" type="text" class="@error('name') is-invalid @enderror w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:border-sky-500" />
                  @error('name')
                  <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                  </span>
            ...
            <div>
               ...
               <div class="mt-1">
                  <input type="password" name="password" autocomplete="current-password" id="user-password" placeholder="Informe a senha" class="@error('password') is-invalid @enderror w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:border-sky-500" />
                  @error('password')
                  <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                  </span>
            ...
            <div>
               ...
               <div class="mt-1">
                  <input name="password_confirmation" autocomplete="new-password" id="password-confirm" placeholder="Repita a senha" type="password" class="@error('password') is-invalid @enderror w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:border-sky-500" />
            ...
            <div class="flex items-center">
               ...
               <label for="agree" class="ml-2 block text-md font-medium text-gray-900">Concordo com os
