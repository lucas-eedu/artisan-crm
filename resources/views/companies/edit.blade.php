               ...
               <div class="card-body">
                  ...
                  <div class="form-group">
                     ...
                     <select id="status" class="select2 form-control @error('status') is-invalid @enderror" name="status">
                        <option value="">Selecione</option>
                        <option value="active" @if ("active" == old('status', $company->status)) selected="selected" @endif>Ativo - Com acesso ao CRM</option>
                        <option value="inactive" @if ("inactive" == old('status', $company->status)) selected="selected" @endif>Inativo - Sem acesso ao CRM</option>
                     </select>
                     @error('status')
                        <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
